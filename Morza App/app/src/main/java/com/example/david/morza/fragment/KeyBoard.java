        ...
        btnPoint.setOnClickListener(    new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (askPass.length() >= 5) {
                    ...
                    getSetTextObject.vibration(RequestCode.pointOrCLear);
                    textLetter = "";
        ...
        btnTire.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (askPass.length() >= 5) {
                    ...
                    getSetTextObject.vibration(RequestCode.tireOrEnter);
                    textLetter = "";
            ...
            public void onClick(View v) {
                ...
                if (askPass.compareTo(RequestCode.ASK_CLEAN) == 0) {
                    ...
                    if (textLetter.compareTo(RequestCode.ASK_CLEAN) == 0 && askPass.compareTo(RequestCode.ASK_CLEAN) != 0) {
                        getSetTextObject.vibration(RequestCode.bad);
...
//                editMessage.setText(textMessage);
    ...
    public interface OnSelectedButtonListener{
        ...
        boolean mabecheck();
        void vibration(long vibrateTime);
    }
}
